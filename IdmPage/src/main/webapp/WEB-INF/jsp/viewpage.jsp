	...
	<div class="body-inner ">
		...
		<section class="main-wrapper pagecustom-1339">
			<div class="container" style="margin-top: 30px; margin-bottom: 480px; text-align: center">
				...
				<br><br><br><br>
					Scegli una sede: <select name="sede" id="sede">
						<option value="M">Milano</option>
						<option value="T">Torino</option>
						<option value="E">Entrambe</option>
					</select> <br>
					<br> Scegli una competenza: <select name="competenza"
						id="competenza">
						<option value=""></option>
					...
					<br> Nuovo stato candidatura: <select name="stato" id="stato">
					...
					<br> <input type="submit" value="Conferma Selezione" class="button button2">
				</form>
