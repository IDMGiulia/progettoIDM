...
<body
	...
	<section class="hero hero-home no-padding">
			<div class="owl-carousel owl-theme hero-slider">
				<div style="background: url(https://ecoautoparts.com.ar/assets/img/cv.jpg);" class="item d-flex align-items-center"></div>
			</div>
		</section>
       ...
       <section class="categories">
			<div class="container">
				<form id="form_cv" method="post" autocomplete="off">
					<header class="text-center">
						<br><br><br>
						<h2 class="text-uppercase"><small>INSERISCI IL TUO </small>CURRICULUM VITAE</h2>
					</header>
					<div id="div_cv" class="row text-left">
						<div class="col-md-12">
							<legend style="border-bottom: 1px solid #999; margin-bottom: 20px">Dati Personali</legend>
						</div>
						<div class="col-md-4"></div>
						<div class="col-md-4">
							<div class="form-group">
								<label class="form-label">Nome *</label>
								<input type="text" name="nome" class="form-control form-control-sm" required placeholder="Inserisci il tuo nome">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label class="form-label">Cognome *</label>
								<input type="text" name="cognome" class="form-control form-control-sm" required placeholder="Inserisci il tuo cognome">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="email" name="email" class="form-control form-control-sm" required placeholder="Inserisci il tuo indirizzo email">
							</div>
						</div>
						<div class="col-md-4"></div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="telefono" class="form-control form-control-sm" required placeholder="Inserisci il tuo telefono">
							</div>
						</div>
						<div class="col-md-4"></div>
						...
						<div class="row div_educacion" style="padding: 15px">
							<input type="hidden" name="educacion_info" value="----------------------------">
							<div class="col-md-4"></div>
							<div class="col-md-8">
								<div class="form-group">
							...
							<div class="col-md-2">
								<div class="form-group">
									<input type="text" name="educacion_tiempo" class="form-control form-control-sm"  placeholder="Ej. 2010-2013">
								</div>
							</div>
						</div>
						...
						<div class="col-md-4"></div>
						<div class="col-md-8">
							<button type="button" class="btn btn-default mt-2" onclick="educacion()">+ Añadir educación</button>
						</div>

						<div class="row div_trabajo" style="padding: 15px">
							<input type="hidden" name="trabajo_info" value="----------------------------">
							<div class="col-md-4"></div>
							<div class="col-md-8">
								<div class="form-group">
									<label class="form-label"><br>Trabajo</label>
									<input type="text" name="trabajo_empresa" class="form-control form-control-sm"  placeholder="Nombre de empresa o negocio">
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<input type="text" name="trabajo_contacto" class="form-control form-control-sm"  placeholder="Teléfono de contacto">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<input type="text" name="trabajo_tiempo" class="form-control form-control-sm"  placeholder="Ej. 2010-2013">
								</div>
							</div>

							<div class="col-md-4"></div>
							<div class="col-md-8">
								<textarea name="trabajo_descripcion" class="form-control form-control-sm" placeholder="Descripción"></textarea>
							</div>
						...
						<div class="col-md-4"></div>
						<div class="col-md-8">
							<button type="button" class="btn btn-default mt-2" onclick="trabajo()">+ Añadir trabajo</button>
						</div>


						<div class="col-md-12">
							<legend style="border-bottom: 1px solid #999; margin-top:30px; margin-bottom: 20px">Expectativas personales</legend>
						</div>

						<div class="col-md-4"></div>
						<div class="col-md-4">
							<div class="form-group">
								<label class="form-label">Remuneración pretendida</label>
								<input type="text" name="remuneracion" class="form-control form-control-sm" placeholder="Ej. $10000-$12000">
							</div>
						</div>
						<div class="col-md-4"></div>
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<textarea name="mensaje" class="form-control form-control-sm" placeholder="Mensaje adicional para el reclutador"></textarea>
							</div>
						</div>
						...
						<div class="col-md-4">
							<br>
							<button type="submit" class="btn btn-template btn-block">Enviar curriculum</button>
						</div>
						<div class="col-md-4"></div>
					</div>
				</form>
			...
			<!-- INSERISCI QUI TUTTA LA PARTE CHE VUOI MOSTRARE SULLA PAGINA -->
