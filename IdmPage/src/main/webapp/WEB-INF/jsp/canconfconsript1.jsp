...
<script>
 function caricaCitta(){
	...
	if (citta=="M"){
		document.getElementById("img_citta").src="/IdmPage/img/milano.jpg";
	} else if (citta=="T"){
		document.getElementById("img_citta").src="/IdmPage/img/torino2.jpg";
	}else{
		document.getElementById("img_citta").src="<%=request.getContextPath()%>/img/entrambi2.jpg";
	}
 }         
</script>
	<!-- Page Main Wrapper -->
