		...
		<section class="main-wrapper pagecustom-1339">
			<div class="container" style="margin-top: 30px">
				...
				<div style="text-align: left">
					<h1>Complimenti!</h1>
					<h3>La tua registrazione si � conclusa con successo. Controlla
						i tuoi dati:</h3>
					<br>
					<div class="row">
									...
									<br>
										<script>
										 function caricaCitta(){
											...
											var immagine
											if (citta=="M"){
												return immagine="/IdmPage/img/milano.jpg";
											} else if (citta=="T"){
												return immagine="/IdmPage/img/torino2.jpg";
											}else{
												return immagine="/IdmPage/img/entrami2.jpg";
											}
										 }    
										document.getElementById("demo").innerHTML = caricaCitta()
										</script>
										<input type="hidden" id="citta" value="can.luogoCandidatura">
										<div onload="caricaCitta()">
											<img src="x=caricaCitta()">
										</div>
